...
Rule #1: If you want exception to ANY rule, YOU MUST STOP and get explicit permission from Brian first. BREAKING THE LETTER OR SPIRIT OF THE RULES IS FAILURE.
...
- Never delete a test because it's failing. Instead, raise the issue with Brian.
